...
namespace Kulki.ServiceReference1 {
    ...
    public interface IGlobalScoreBoard {
        ...
        bool SendScoreToServer(Kulki.ServiceReference1.Score score);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGlobalScoreBoard/SendScoreToServer", ReplyAction="http://tempuri.org/IGlobalScoreBoard/SendScoreToServerResponse")]
        System.Threading.Tasks.Task<bool> SendScoreToServerAsync(Kulki.ServiceReference1.Score score);
        ...
        Kulki.ServiceReference1.Score[] GetAllScores();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGlobalScoreBoard/GetAllScores", ReplyAction="http://tempuri.org/IGlobalScoreBoard/GetAllScoresResponse")]
        System.Threading.Tasks.Task<Kulki.ServiceReference1.Score[]> GetAllScoresAsync();
        ...
        Kulki.ServiceReference1.Score[] GetScoresByNick(string nick);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGlobalScoreBoard/GetScoresByNick", ReplyAction="http://tempuri.org/IGlobalScoreBoard/GetScoresByNickResponse")]
        System.Threading.Tasks.Task<Kulki.ServiceReference1.Score[]> GetScoresByNickAsync(string nick);
        ...
        Kulki.ServiceReference1.Score[] GetScoresByBoardSize(int boardSize);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGlobalScoreBoard/GetScoresByBoardSize", ReplyAction="http://tempuri.org/IGlobalScoreBoard/GetScoresByBoardSizeResponse")]
        System.Threading.Tasks.Task<Kulki.ServiceReference1.Score[]> GetScoresByBoardSizeAsync(int boardSize);
        ...
        Kulki.ServiceReference1.Score[] GetScoresByColorNumbers(int colors);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGlobalScoreBoard/GetScoresByColorNumbers", ReplyAction="http://tempuri.org/IGlobalScoreBoard/GetScoresByColorNumbersResponse")]
        System.Threading.Tasks.Task<Kulki.ServiceReference1.Score[]> GetScoresByColorNumbersAsync(int colors);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IGlobalScoreBoardChannel : Kulki.ServiceReference1.IGlobalScoreBoard, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GlobalScoreBoardClient : System.ServiceModel.ClientBase<Kulki.ServiceReference1.IGlobalScoreBoard>, Kulki.ServiceReference1.IGlobalScoreBoard {
        ...
        public bool SendScoreToServer(Kulki.ServiceReference1.Score score) {
            return base.Channel.SendScoreToServer(score);
        }
        
        public System.Threading.Tasks.Task<bool> SendScoreToServerAsync(Kulki.ServiceReference1.Score score) {
            return base.Channel.SendScoreToServerAsync(score);
        }
        
        public Kulki.ServiceReference1.Score[] GetAllScores() {
            return base.Channel.GetAllScores();
        }
        
        public System.Threading.Tasks.Task<Kulki.ServiceReference1.Score[]> GetAllScoresAsync() {
            return base.Channel.GetAllScoresAsync();
        }
        
        public Kulki.ServiceReference1.Score[] GetScoresByNick(string nick) {
            return base.Channel.GetScoresByNick(nick);
        }
        
        public System.Threading.Tasks.Task<Kulki.ServiceReference1.Score[]> GetScoresByNickAsync(string nick) {
            return base.Channel.GetScoresByNickAsync(nick);
        }
        
        public Kulki.ServiceReference1.Score[] GetScoresByBoardSize(int boardSize) {
            return base.Channel.GetScoresByBoardSize(boardSize);
        }
        
        public System.Threading.Tasks.Task<Kulki.ServiceReference1.Score[]> GetScoresByBoardSizeAsync(int boardSize) {
            return base.Channel.GetScoresByBoardSizeAsync(boardSize);
        }
        
        public Kulki.ServiceReference1.Score[] GetScoresByColorNumbers(int colors) {
            return base.Channel.GetScoresByColorNumbers(colors);
        }
        
        public System.Threading.Tasks.Task<Kulki.ServiceReference1.Score[]> GetScoresByColorNumbersAsync(int colors) {
